    ...
    <div className="flex flex-col gap-4 p-4 pb-0">
      <div className="grid grid-cols-3 gap-4">
        <div className="text-center">
          ...
          <p className="text-lg text-primary font-semibold">{formatCurrencyWithCompact(10000000)}</p>
        </div>

        <div className="text-center">
          <p className="text-base-content/60 text-xs">{t('expenses.stat.totalExpenses')}</p>
          <p className="text-lg text-accent font-semibold">{formatCurrencyWithCompact(10000000)}</p>
        </div>

        <div className="text-center">
          <p className="text-base-content/60 text-xs">{t('expenses.stat.difference')}</p>
          <p className="text-lg text-success font-semibold">{formatCurrencyWithCompact(10000000)}</p>
        </div>
      </div>
